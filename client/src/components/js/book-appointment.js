        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            <div className={styles.mainContainer} class="container-fluid px-5 py-2 mx-auto" style={{ margin: '40px 0px 40px 0px' }}>
                ...
                <div>
                    ...
                    <div>
                        <p>Fill out the information below, so we can schedule your house cleaning service.</p>
                    </div>
                    <Container>
                        <Form onSubmit={handleSubmit}>
                            ...
                            <div className={styles.button}>
                                <button className={design['button-17']} type='submit'>Book Appointment</button>
                            </div>
                        </Form>
                    </Container>
                </div>
